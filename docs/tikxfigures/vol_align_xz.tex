...
\begin{tikzpicture}[scale=3,tdplot_main_coords]
  ...
  \node[draw=none,color=blue] at (0.4,0.0,-0.09) {$r_x \cos (\theta_x)$};
  \node[draw=none,rotate=90,color=blue] at (-0.09,0.0,0.75) {$r_x \sin (\theta_x)$};
  %\node[draw=none,color=red] at (0.05,0.09,0.05) {$\theta_x$};
