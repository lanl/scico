...
def _step_t(batch_x: ArrayLike, key: ArrayLike) -> Tuple[ArrayLike, ArrayLike]:
...
@nnx.jit(static_argnums=(1, 4))
def train_step_diffusion(model: Callable,
               criterion: Callable,
...
def eval_step_diffusion(model: Callable,
              criterion: Callable,
              metrics: nnx.MultiMetric,
              step_loss: Callable,
              batch_x: ArrayLike,
...
def jax_train_step_diffusion(graphdef,
                   state,
                   criterion: Callable,
                   step_loss: Callable,
                   batch_x: ArrayLike,
