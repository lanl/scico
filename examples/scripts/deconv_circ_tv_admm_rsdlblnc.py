...
from scico.optimize.admm import ADMM, CircularConvolveSolver, ResidualBalancing
...
scico.plot.close("all")

for rho in [1e-2, 1e0, 1e2]:
    solver = ADMM(
        f=f,
        g_list=[g],
        C_list=[C],
    ...
    plot.plot(
        ...
        ptyp="semilogy",
        title=f"Residuals, rho_0={rho:.1e}",
        xlbl="Iteration",
        lgnd=("Primal", "Dual"),
        fig=fig,
        ax=ax[1],
